...
function buildTopicSelectionGrid() {
    ...
    const completedTopics = JSON.parse(localStorage.getItem('completedTopicsFirstAssessment') || '[]');
...
function markTopicCompleted(topicName) {
    ...
    if (!completedTopics.includes(topicName)) {
        ...
        localStorage.setItem('completedTopicsFirstAssessment', JSON.stringify(completedTopics));
    }
}
